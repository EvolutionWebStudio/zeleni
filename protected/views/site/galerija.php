...
<div class="bar green">
    <div class="row collapse wide main-gallery">
        ...
        <div class="gallery-navigation clearfix">
            <a href="#" class="float-left gallery-arrow-left">Previous image</a>
            <a href="#" class="float-right gallery-arrow-right">Next image</a>
        </div>

        <ul>
            <li>
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/img/gallery/tresnja/sweet cherries Greeny Arandjelovac_1-1220.jpg" alt="Greeny tresnja"/>
                <p class="gallery-caption">
                   picka materna i neki enorman tekst</br>u dva reda da jebe rak raka
                </p>
            </li>
        </ul>
