...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2014 at 10:55 AM
...
(11, 'Apples', 'jabuka', 2, 'en', 'greeny-thumb-jabuka.jpg'),
...
(66, 'Concrete columns for hail protection structures', '<h1>Production of prestressed concrete columns for hail protection structures, vineyards and fences</h1>\r\n', 'betonski-stubovi', 1, 'en', NULL, 'SELF', '8dc43f'),
...
(91, 'Черешня', '<h1><strong>Черешня</strong></h1>\r\n\r\n<p>3 ha (2.400 <span style="font-family:Arial,helvetica,sans-serif;font-size:14px;line-height:19px">деревьев</span>)</p>\r\n', 'tresnja', 2, 'ru', 89, 'EXTERNAL', '871b43'),
(92, 'Клубника', '<h1><strong>Клубника</strong></h1>\r\n\r\n<p>1 ha (40.000 <span style="font-family:Arial,helvetica,sans-serif;font-size:14px;line-height:19px">кустов</span>)</p>\r\n', 'jagoda', 3, 'ru', 89, 'EXTERNAL', 'a3142c'),
...
(99, 'Железобетонные столбы для противоградовой защ', '<h1>Железобетонные столбы для противоградовой защиты</h1>\r\n', 'betonski-stubovi', 5, 'ru', NULL, 'SELF', '8dc43f'),
...
(46, 'greeny-everyday-sok-moderno-pakovanje-eng.jpg', 49),
(47, 'greeny-everyday-sok-reklamni-frizider-eng.jpg', 49),
...
(86, 'greeny-everyday-sok-moderno-pakovanje-ru.jpg', 82),
(87, 'greeny-everyday-sok-reklamni-frizider-ru.jpg', 82),
...
(70, 'Sidebar', 'Red chief', 61, 'en', 2, 59),
...
(77, 'Main', 'Golden delicious Apple', 62, 'en', 1, 48),
(78, 'Main', 'Red chief Apple', 61, 'en', 2, 48),
(79, 'Main', 'Fuji Apple', 65, 'en', 3, 48),
(80, 'Main', 'Granny smith Apple', 64, 'en', 5, 48),
(81, 'Main', 'Jonagold Apple', 63, 'en', 4, 48),
(82, 'Main', 'Gala Apple', 60, 'en', 6, 48),
...
(113, 'Sidebar', 'Золотой делишес ', 95, 'ru', 1, 103),
(114, 'Sidebar', 'Ред чиф', 94, 'ru', 2, 103),
(115, 'Sidebar', 'Йонаголд', 96, 'ru', 4, 103),
(116, 'Sidebar', 'Гренни смит ', 97, 'ru', 5, 103),
(117, 'Sidebar', 'Гала ', 93, 'ru', 6, 103),
...
(123, 'Main', 'Яблоки Фуджи', 98, 'ru', 3, 92),
(124, 'Main', 'Яблоки Гренни смит ', 97, 'ru', 5, 92),
(125, 'Main', 'Яблоки Йонаголд', 96, 'ru', 4, 92),
(126, 'Main', 'Яблоки Гала', 93, 'ru', 6, 92),
(127, 'Main', 'Сок EveryDay', 82, 'ru', 7, 92),
(128, 'Main', 'Черешня', 91, 'ru', 8, 92),
...
(8, '', '<p>Hvala vam &scaron;to ste odvojili vreme da kontaktirate s nama! Ako na na&scaron;em sajtu niste na&scaron;li informacije koje su vam potrebne, molimo vas da popunite kontakt formu i po&scaron;aljite e-poruku. U skladu sa politikom privatnosti kompanije Greeny, va&scaron;i lični podaci će se čuvati u tajnosti i koristiti samo za odgovor e-po&scaron;tom ili radi slanja materijala u digitalnom obliku.</p>\r\n\r\n<p>Greeny d.o.o. Aranđelovac,</p>\r\n\r\n<p>Ora&scaron;ac bb,</p>\r\n\r\n<p>34308 Ora&scaron;ac,</p>\r\n\r\n<p>Srbija</p>\r\n\r\n<p>T:+381 34 6709-141<br />\r\nF:+381 34 6709-230<br />\r\ne-mail: greeny@vozd.net<br />\r\nwww.greeny.co.rs</p>\r\n', 'sr', '', '', 9, 1),
...
(62, 'Nutritional values', '<p><img alt="" src="/img/articles/everyday-table-en.jpg" /></p>\r\n', 'en', '', '', 76, 2),
...
(101, '', '<p>Благодарим Вас за то, что вы нашли время для связи с нами! Если Вы на нашем сайте не нашли интересующую Вас информацию, то просим заполнить анкету для контакта и отправить нам электронное сообщение. В соответствии с политикой защиты персональных данных, проводимой фирмой, Ваши персональные данные для нас конфиденциальны и будут использоваться только для ответа по электронной почте или для отправления материала в цифровой форме.</p>\r\n\r\n<p>ООО &laquo;Гренни&raquo; Аранджеловац,</p>\r\n\r\n<p>Орашац б/н,</p>\r\n\r\n<p>34308 Орашац,</p>\r\n\r\n<p>Республика Сербия</p>\r\n\r\n<p>T:+381 34 6709-141<br />\r\nF:+381 34 6709-230<br />\r\ne-mail: greeny@vozd.net<br />\r\nwww.greeny.co.rs</p>\r\n', 'ru', '', '', 77, 1),
(102, '', '<p>Аранджеловац находится с северо-восточной стороны подножья лесистой горы Букуля (696 м над уровнем моря.), на высоте 250 метров над уровнем моря, у истоков реки Кубршница. Община (административный округ) простилается на 375,89 км2 и насчитывает 48.000 жителей.</p>\r\n\r\n<p>ООО «Гренни» Аранджеловац,</p>\r\n\r\n<p>Орашац  б/н,</p>\r\n\r\n<p>34308 Орашац,</p>\r\n\r\n<p>Республика Сербия</p>\r\n\r\n<p>T:+381 34 6709-141<br />\r\nF:+381 34 6709-230<br />\r\ne-mail: greeny@vozd.net<br />\r\nwww.greeny.co.rs</p>\r\n', 'ru', '', '', 78, 2),
...
(123, 'Таблица калорийности', '<p><img alt="" src="/img/articles/everyday-table-ru.jpg" /></p>\r\n', 'ru', '', '', 109, 2);
...
(8, 2, 'everyday-sok', 'Greeny EveryDay', '<img src="/img/slider/greeny-everyday-sok-logo-eng.png"/>\r\n<hgroup>\r\n<h2>100% natural juice</h2>\r\n</hgroup>\r\n\r\n', 'greeny-everyday-sok-slide-eng.jpg', 'en', '8dc43f'),
...
(14, 2, 'everyday-sok', 'Сок «EveryDay”', '<img src="/img/slider/greeny-everyday-sok-logo-ru.png"/>\r\n<hgroup>\r\n<h2>100%  натуральный сок</h2>\r\n</hgroup>\r\n\r\n', 'greeny-everyday-sok-slide-ru.jpg', 'ru', '8dc43f'),
...
('m140427_191103_change_category_title', 1398625909);
